  ...
  const experiences = [
    {
    ...
    },
     {
      ...
      description: "Designed and tested μ-metal torque rod assemblies and three-axis search-coil magnetometer sensors for spacecraft applications. Engineered innovative switch circuitry enabling dual-mode operation between attitude control and AC sensing."
    },
    {
